...
class HeaderIndexer extends Indexer {
  ...
  fromOptions(options) {
    if (options.startHeight) {
      ...
      // TODO: confirm if this should be "<" or "<="
      // TODO: account for startTip and no startHeight
      if (lastCheckpoint - options.startHeight < retargetInterval)
        this.startHeight = options.startHeight - (options.startHeight % retargetInterval)
